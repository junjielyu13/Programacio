...
public class CintaTransportadora extends Remuntador { 
    ...
    /**
     * Construdor CintaTransportadora
     ...
     */
    public CintaTransportadora(String nom, String sector, String estat, int limitVent, boolean afectatPerVisibilitat) {
    ...
    @Override
    public String tipus(){                
        String tipus = "CintaTransportadora";
        return tipus;
    }
