package linzhihanlijunjie_l3.controlador;

import java.io.IOException;
import java.util.ArrayList;
import java.util.List;

import linzhihanlijunjie_l3.model.Dades;
...
public class Controlador {
    ...
    public String VisualitzarArticles(){
        String str = "";
        List<String> llistaStringArticles = new ArrayList<String>(this.dades.recuperaArticles());
